 ...
 *         Szymon Potrzebowski <sp438683@students.mimuw.edu.pl>
 ...
 * Wyznacza następujący ciąg numerów: jeżeli numer @p x jest przekierowany na 
 * jakiś prefiks numeru @p num to @p x skonkatenowany z @p num bez prefiksu na 
 * który jest przekierowany @p x należy do wyniku wywołania 
 * @ref phfwdReverse z numerem @p num. Dodatkowo ciąg wynikowy zawsze zawiera 
 * też numer @p num. Wynikowe numery są posortowane leksykograficznie po 
 * wartości znaków i nie mogą się powtarzać. Jeśli podany napis nie
